...
jQuery(document).ready( function($) {
	 ...
	 */
	$('#mwb_ubo_offer_purchased_earlier, #mwb_ubo_offer_replace_target, #mwb_ubo_offer_global_funnel, #mwb_ubo_offer_exclusive_limit, #mwb_ubo_offer_meta_forms, #mwb_ubo_offer_restrict_coupons, #mwb_ubo_exclusive_offer, #mwb_ubo_orderbump_popup, #mwb_upsell_bump_priority').on( 'click', function (e) {
