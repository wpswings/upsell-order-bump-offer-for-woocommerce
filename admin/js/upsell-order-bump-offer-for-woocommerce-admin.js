(function( $ ) {
	...
	$( document ).ready(
		function(){
			...
			$( '.wps_ubo_lite_bump_create_button' ).on(
				'click',
				function (e) {
			...
			$( '.wps_ubo_lite_go_pro_popup_close' ).on(
				'click',
				function (e) {
			...
			$( '#wps_bump_template_type_select' ).on(
				'change',
				function () {
					var v = $( this ).val();
			...
			$( '.wps_ubo_bottom_vertical_spacing_slider' ).on(
				'change',
				function () {
					var v = $( this ).val();
			...
			$( '.wps-ubo-appearance-template' ).on(
				'click',
				function(e) {
			...
			$( '.wps_ubo_template_layout_yes' ).on(
				'click',
				function(e) { // Template chnage css and design.
			...
			$( '.wps_ubo_preview_select_border_type' ).on(
				'change',
				function () {
			...
			$( '.wps_ubo_top_vertical_spacing_slider' ).on(
				'change',
				function () {
			...
			$( '.wps_ubo_product_price_slider' ).on(
				'change',
				function () {     // 2.1.7
			...
			$( '.wps_ubo_product_img_height_slider' ).on(
				'change',
				function() {
			...
			$( '.wps_ubo_product_img_width_slider' ).on(
				'change',
				function() {
			...
			$( '.wps_ubo_accept_offer_slider' ).on(
				'change',
				function () {
			...
			$( '.wps_ubo_offer_description_slider' ).on(
				'change',
				function () {
...
jQuery( document ).ready(
	function($) {
		...
		$( '#wps_upsell_bump_status_input' ).click(
			function() {
		 ...
		 */
		$( '#wps_ubo_offer_purchased_earlier,#wps_ubo_enable_popup_exit_intent_switch,#wps_enable_cart_upsell_location,#wps_ubo_offer_timer,#wps_ubo_offer_product_image_slider,#wps_enable_cart_upsell, #wps_ubo_offer_replace_target, #wps_ubo_offer_global_funnel, #wps_ubo_offer_exclusive_limit, #wps_ubo_offer_meta_forms, #wps_enable_red_arrow_feature,.wps_bump_offer_popup_case ,#wps_ubo_offer_restrict_coupons, #wps_ubo_offer_ab_method,#wps_upsell_bump_priority, #wps_upsell_bump_min_cart,#wps_ubo_img_width_slider_pop_up,#wps_ubo_img_height_slider_pop_up,#wps_ubo_select_accept_offer_acolor_pop_up' ).on(
			'click',
			function (e) {
		...
		$( '#wps_ubo_premium_popup_4_template,#wps_ubo_premium_popup_3_template,#wps_ubo_premium_popup_5_template,#wps_ubo_premium_popup_6_template,#wps_ubo_premium_popup_7_template,#wps_ubo_premium_popup_8_template,#wps_ubo_premium_popup_9_template' ).on(
			'click',
			function (e) {
		...
		jQuery( '#wps_ubo_offer_purchased_earlier' ).on(
			'click',
			function(e){
		...
		// If org is updated but pro is not.
		jQuery( '#wps_ubo_offer_exclusive_limit' ).on(
			'change',
			function(e){
		...
		jQuery( '.wps_ubo_update_yes, .wps_ubo_update_no' ).click(
			function(e) {
		...
		jQuery( '.wps_ubo_skin_popup_head img' ).attr(
			'src',
			function( index,attr ) {
		...
		function wps_ubo_change_template_img_src( template_data_link_id = false ) {
			...
			jQuery( template_data_link ).attr(
				'src',
				function( index,attr ) {
