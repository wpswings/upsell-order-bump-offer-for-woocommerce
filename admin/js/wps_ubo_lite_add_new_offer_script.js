jQuery(document).ready(function ($) {
  ...
  $(document).on(
    "click",
    "#wps_upsell_dismiss_elementor_inactive_notice",
    function (e) {
      e.preventDefault();
    ...
    function upsell_create_new_offer_post_request(index, funnel) {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          // Remove Added Offers.
          jQuery(".wps_wocuf_pro_delete_new_created_offers").on(
            "click",
            function (e) {
              e.preventDefault();
              var btn_id = $(this).data("id");
              jQuery(
                "div.new_created_offers[data-id='" + btn_id + "']"
  ...
  (function ($) {
    ...
    $(document).ready(function () {
      jQuery(".wps_ubo_lite_go_pro_popup_close").attr(
        "href",
        "javascript:void(0)"
      );
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (true === data.status) {
          ...
          current_button
            .closest(".wps_upsell_offer_templates_parent")
            .find(".wps_wocuf_pro_offer_template_input")
            .val(template_id);
          ...
          href_funnel_offer_url +=
            "&wps-upsell-offer-section=offer-section-" + offer_id;
  ...
  $(document).on(
    "click",
    ".wps-ufw_msm-head>.dashicons-arrow-left-alt",
    function () {
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(document).on("click", ".wps-ufw_btn-act-main", function () {
      $(this)
        .nextAll(".wps-ufw_btn-act-desc")
        .toggleClass("wps-ufw_btn-active");
    ...
    $(document).on(
      "click",
      ".wps-ufw_adp-head .dashicons,.wps-ufw_adpf-btn.wps-ufw_adpf-cancel",
      function () {
    ...
    $(".wps-ufw_msmh-in-btn").on("click", function () {
      ...
      var shipping_information_title = jQuery(
        "#billing-information-wrap-editable"
      ).html();
      var shipping_method_title = jQuery(
        "#shipping-method-wrap-editable"
      ).html();
      var order_summary_title = jQuery("#order-Summary-wrap-editable").html();
      var payment_method_title = jQuery(
        "#payment-gateway-wrap-editable"
      ).html();
      ...
      var checkout_coupon_enabled = jQuery("#coupon_field_checkout").prop(
        "checked"
      );
      var checkout_order_note_enabled = jQuery("#order_note_checkout").prop(
        "checked"
      );
    ...
    $(".wps-ufw_msmhthy-in-btn").on("click", function () {
      var wps_wocuf_content_before_order_details = jQuery(
        "#wps_wocuf_content_before_order_details"
      ).val();
      var wps_wocuf_content_page_header_title = jQuery(
        "#wps_wocuf_content_page_header_title"
      ).val();
      var wps_wocuf_content_after_order_details = jQuery(
        "#wps_wocuf_content_after_order_details"
      ).val();
      var wps_wocuf_content_billing_and_shipping = jQuery(
...
jQuery(document).ready(function ($) {
  ...
  jQuery(".wps_wocuf_pro_delete_old_created_offers").on("click", function (e) {
    e.preventDefault();
    var btn_id = $(this).data("id");
    jQuery(".new_created_offers[data-id='" + btn_id + "']").slideUp(
      "slow",
      function () {
        $(this).remove();
      }
