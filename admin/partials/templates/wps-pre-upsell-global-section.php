			...
			<tbody>
				...
				<tr valign="top">
					...
					<td class="forminp forminp-text">
						...
						<a class="wps_ubo_inline_link_button" href="<?php echo esc_url(admin_url('edit.php?post_type=page')); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e('Create custom success page', 'upsell-order-bump-offer-for-woocommerce'); ?></a>
					</td>
				</tr>
...
<div id="wps_ubo_popup_modal" class="wps-ubo-modal wps-ubo-popup-style-wrapper">
				...
				<td>
					...
					<select id="wps_ubo_popup_type" style="width:260px; max-width:100%;">
						...
						<option value="slidein" <?php selected($saved_type, 'slidein'); ?>>
							<?php esc_html_e('Slide-Down', 'upsell-order-bump-offer-for-woocommerce'); ?>
						</option>

						<option value="slideleft" <?php selected($saved_type, 'slideleft'); ?>>
							<?php esc_html_e('Slide-Left', 'upsell-order-bump-offer-for-woocommerce'); ?>
						</option>

						<option value="slideright" <?php selected($saved_type, 'slideright'); ?>>
							<?php esc_html_e('Slide-Right', 'upsell-order-bump-offer-for-woocommerce'); ?>
						</option>

						<option value="slideup" <?php selected($saved_type, 'slideup'); ?>>
							<?php esc_html_e('Slide-Up', 'upsell-order-bump-offer-for-woocommerce'); ?>
						</option>

						<option value="zoomout" <?php selected($saved_type, 'zoomout'); ?>>
							<?php esc_html_e('Zoom-Out', 'upsell-order-bump-offer-for-woocommerce'); ?>
						</option>
