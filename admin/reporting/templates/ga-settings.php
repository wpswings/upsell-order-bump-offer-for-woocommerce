...
$google_analytics_fields = array(
	...
	'wps_wocuf_ga_account_id'         => array(
		...
		'type'                  => 'text',
		'required'              => true,
		'attribute_description' => esc_html__('Log into your google analytics account to find your ID. eg: UA-XXXXXX-X', 'upsell-order-bump-offer-for-woocommerce'),
		'placeholder'           => esc_html__('UA-XXXXXX-X', 'upsell-order-bump-offer-for-woocommerce'),
	...
	'wps_wocuf_enable_basecode'       => array(
		...
		'type'                  => 'checkbox',
		'required'              => false,
		'attribute_description' => esc_html__('Add Global Site Tag \'gtag.js\' to your website', 'upsell-order-bump-offer-for-woocommerce'),
		'note'                  => esc_html__('Only Enable this when you are not using any other Google analytics tracking on your website.', 'upsell-order-bump-offer-for-woocommerce'),
	...
	'wps_wocuf_enable_purchase_event' => array(
		...
		'type'                  => 'checkbox',
		'required'              => false,
		'attribute_description' => esc_html__('This will trigger Google Analytics Purchase Event for Parent Order and for Upsells accordingly with respect to payment gateways.', 'upsell-order-bump-offer-for-woocommerce'),
		'note'                  => esc_html__('Make sure you disable your Purchase event if you are using any other Google analytics tracking on your website else it will track data twice.', 'upsell-order-bump-offer-for-woocommerce'),
		...
		<tbody>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label><a target="_blank" href="https://wordpress.org/plugins/enhanced-e-commerce-for-woocommerce-store/"><?php esc_html_e('Enhanced Ecommerce Google Analytics Plugin for WooCommerce', 'upsell-order-bump-offer-for-woocommerce'); ?></a></label>
					<span class="wps_upsell_other_plugin_author_name"><?php esc_html_e('By Tatvic', 'upsell-order-bump-offer-for-woocommerce'); ?></span>
				</th>
				<td class="forminp forminp-text">
					<span class="wps_upsell_global_description">
						<?php esc_html_e('We have added inbuilt Compatibility with Enhanced Ecommerce Google Analytics plugin so it\'s Google Analytics Purchase Event will be automatically disabled as soon as you Enable Google Analytics Purchase Event by Upsell.', 'upsell-order-bump-offer-for-woocommerce'); ?>
					</span>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label><a target="_blank" href="https://wordpress.org/plugins/pixelyoursite/"><?php esc_html_e('PixelYourSite', 'upsell-order-bump-offer-for-woocommerce'); ?></a></label>
				...
				<td class="forminp forminp-text">
					<span class="wps_upsell_global_description">
						...
						printf(
							...
							esc_html__('Enable the purchase event on Google Analytics', 'upsell-order-bump-offer-for-woocommerce'),
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label><?php esc_html_e('Other Google Analytics Tracking Plugins', 'upsell-order-bump-offer-for-woocommerce'); ?></label>
				</th>
				<td class="forminp forminp-text">
					<span class="wps_upsell_global_description">
						<?php esc_html_e('Please make sure to Disable the Purchase Event from your plugin\'s settings before you Enable Google Analytics Purchase Event by Upsell. If you can\'t find the settings or in case of any confusion please contact our support', 'upsell-order-bump-offer-for-woocommerce'); ?> <a target="_blank" href="https://wpswings.com/contact-us/?utm_source=wpswings-official&utm_medium=upsell-org-backend&utm_campaign=official"><?php esc_html_e('here', 'upsell-order-bump-offer-for-woocommerce'); ?></a><?php esc_html_e('.', 'upsell-order-bump-offer-for-woocommerce'); ?>
					</span>
				</td>
			</tr>
		</tbody>
