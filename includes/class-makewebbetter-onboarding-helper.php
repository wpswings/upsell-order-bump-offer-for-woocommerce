...
class Makewebbetter_Onboarding_Helper {
	 ...
	 * @since 1.0.0
	 */
	private static $plugin_name = 'Upsell Order Bump Offer for WooCommerce';
	...
	public function enqueue_styles() {
		...
		if ( $this->is_valid_page_screen() ) {
			...
			wp_enqueue_style( 'makewebbetter-onboarding-style', UPSELL_ORDER_BUMP_OFFER_FOR_WOOCOMMERCE_URL . 'admin/css/makewebbetter-onboarding-admin.css', array(), '1.0.0', 'all' );

			// Uncomment Only when your plugin doesn't uses the Select2
			wp_enqueue_style( 'makewebbetter-onboarding-select2-style', UPSELL_ORDER_BUMP_OFFER_FOR_WOOCOMMERCE_URL . 'admin/css/select2.min.css', array(), '1.0.0', 'all' );
		}
	}
	...
	public function enqueue_scripts() {
		...
		if ( $this->is_valid_page_screen() ) {
			...
			wp_enqueue_script( 'makewebbetter-onboarding-scripts', UPSELL_ORDER_BUMP_OFFER_FOR_WOOCOMMERCE_URL . 'admin/js/makewebbetter-onboarding-admin.js', array( 'jquery' ), '1.0.0', true );
			...
			// Uncomment Only when your plugin doesn't uses the Select2
			wp_enqueue_script( 'makewebbetter-onboarding-select2-script', UPSELL_ORDER_BUMP_OFFER_FOR_WOOCOMMERCE_URL . 'admin/js/select2.min.js', array( 'jquery' ), '1.0.0', false );
		}
	}
