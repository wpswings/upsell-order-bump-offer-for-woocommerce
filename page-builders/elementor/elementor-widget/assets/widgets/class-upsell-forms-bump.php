 ...
 * @since 1.0.0
 */
class Upsell_Forms_Bump extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Upsell Meta Forms', 'upsell-order-bump-offer-for-woocommerce' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shortcode',
			array(
				'label'       => esc_html__( 'Enter upsell meta forms shortcode', 'upsell-order-bump-offer-for-woocommerce' ),
