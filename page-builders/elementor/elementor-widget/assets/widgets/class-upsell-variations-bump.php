...
class Upsell_Variations_Bump extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Upsell Variations', 'upsell-order-bump-offer-for-woocommerce' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shortcode',
			array(
				'label'       => esc_html__( 'Enter upsell variation shortcode', 'upsell-order-bump-offer-for-woocommerce' ),
	...
	protected function render() {
		...
		<?php
		echo wp_kses( $shortcode, wps_upsell_lite_allowed_html_funnel_builder() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
		?>
											</div>
		<?php
	}
