...
<?php
	...
	public function wps_woo_cart_discount_section()
	{
		...
		$condition = function ($value) {
			...
			if (isset($value['wps_upsell_bump_cart_discount_offer_switch'])) {
				return $value['wps_upsell_bump_cart_discount_offer_switch'] == 'yes';
			} else {
	 ...
	 * @since    1.0.0
	 */
	function wps_add_cart_discount_offer_in_cart()
	{
		check_ajax_referer('wps_ubo_lite_nonce_recommend', 'nonce');
